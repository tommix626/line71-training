...
class EnvConfig(object):
    def __init__(self):
        ...
        arr_rates = [0.5 / 60 / 2, 0.5 / 60 / 1.8,  0.5 / 60*1.5, 0.5 * 2 /60,  0.5 / 60 * 3, 0.5 / 60 * 3.5, 0.5 / 60 * 4, \
        0.5 / 60 * 3.2,0.5 / 60 * 3, 0.5 / 60 * 2.5,   0.5 / 60 * 2,   0.5 / 60 * 1.2, 0.5 / 60,  0.5 / 60 / 1.5, 0.5 / 60 / 2, 0.5 / 60 / 4, 0]
        ...
        node_loc   =   [0,     160, 460,550,  950,  1440,1700, 2080,2340, 3030, 3350,3470 ,3760,4230,4560, 5040, 5220, 5820, 6340, 7080, 7300, 8010, 8150,8540,9020, 9210]
        intersec_flag= [False,True,True,False,False,True,False,True,False,False,True,False,True,True,False,False,False,False,False,False,False,False,True,True,False,False]
